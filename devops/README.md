...
```
DEPLOY_ENV=prod
DEPLOY_HOST=pssa2023-ericof.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    pssa2023-ericof.tangrama.com.br:
      ansible_user: root
      host: pssa2023-ericof
      hostname: pssa2023-ericof.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/pssa2023-ericof.tangrama.com.br.yml` to the remote server with:
